...
The current installer is [v0.1.0-pilot.2](https://github.com/nino-chavez/ucp-checkout-qa/releases/tag/v0.1.0-pilot.2). Resolve the [handoff blockers](known-limits.md) and test the installed skill before calling a release ready for routine coworker use.
