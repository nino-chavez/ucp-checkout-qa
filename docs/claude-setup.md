...
> [!IMPORTANT]
> **Current pilot: [v0.1.0-pilot.1](https://github.com/nino-chavez/ucp-checkout-qa/releases/tag/v0.1.0-pilot.1).** Use it for supervised testing. Chrome fixes have merged into the source but are not in this installer. Read the [known limits](known-limits.md) before checkout.
...
1. Open the [pilot release](https://github.com/nino-chavez/ucp-checkout-qa/releases/tag/v0.1.0-pilot.1). Read its release notes and known limits.
