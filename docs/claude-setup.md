...
> [!IMPORTANT]
> **Current pilot: [v0.1.0-pilot.4](https://github.com/nino-chavez/ucp-checkout-qa/releases/tag/v0.1.0-pilot.4).** Use it for supervised testing. Run it from Claude Desktop (Home > Chat). A first-time installation still needs a coworker test. Read the [known limits](known-limits.md) before checkout.
...
1. Open the [pilot release](https://github.com/nino-chavez/ucp-checkout-qa/releases/tag/v0.1.0-pilot.4). Read its release notes and known limits.
